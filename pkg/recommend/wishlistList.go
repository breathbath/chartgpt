...
const RememberRecommendationWineCardContext = `Для формулировки информации для представления рекомендаций пользователю используй только информацию из предоставленной базы данных вин. Текст описания к найденному вину должен быть продающим и представлять собой summary формат, не более 750 символов и содержать в себе следующую информацию в следующем порядке: название вина, его цену, информацию о вкусе, аромате, цене и сочетаемости и блюдами. В конце информации о вине выдай цену в рублях.`
